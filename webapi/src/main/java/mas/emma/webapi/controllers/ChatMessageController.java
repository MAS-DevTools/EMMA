...
import mas.emma.webapi.services.ChatMessageService;
 ...
 */
@RestController
@RequestMapping(ControllerConstants.CHATMESSAGEPATH)
public class ChatMessageController {
    ...
    public <S extends Message> ResponseEntity<Object> create(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
    ...
    public <S extends Message> ResponseEntity update(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
        return runWithErrorHandeling(() -> {
