 ...
 */
@RestController
@RequestMapping(ControllerConstants.APPAUTHPATH)
public class AppAuthController extends BaseController {
    ...
    public <S extends AppAuth> ResponseEntity<Object> create(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
    ...
    public <S extends AppAuth> ResponseEntity update(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
        return runWithErrorHandeling(() -> {
