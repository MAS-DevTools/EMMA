...
import mas.emma.webapi.services.GroupMemberService;
 ...
 */
@RestController
@RequestMapping(ControllerConstants.GROUPMEMBERPATH)
public class GroupMemberController {
    ...
    public <S extends GroupMember> ResponseEntity<Object> create(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
    ...
    public <S extends GroupMember> ResponseEntity update(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
        return runWithErrorHandeling(() -> {
