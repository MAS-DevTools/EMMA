...
import mas.emma.webapi.services.ConversationService;
 ...
 */
@RestController
@RequestMapping(ControllerConstants.CONVERSATIONPATH)
public class ConversationController {
    ...
    public <S extends Conversation> ResponseEntity<Object> create(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
    ...
    public <S extends Conversation> ResponseEntity update(@RequestHeader(required = true) MultiValueMap<String, String> headers, @RequestBody(required = true) S s) {
        return runWithErrorHandeling(() -> {
