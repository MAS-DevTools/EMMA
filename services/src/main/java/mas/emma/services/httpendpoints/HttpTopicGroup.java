...
public class HttpTopicGroup {

    private String base = Application.getSettings().getServerUrl() + ControllerConstants.TOPICGROUPPATH;

    //<editor-fold defaultstate="collapsed" desc="CREATE">
    public <S extends TopicGroup> TopicGroup create(String user_id, S s) {
        String uri = base + ControllerConstants.CREATE;
        return new TopicGroup().valueOf(Application.clientHandlerInstance().getEntity(uri, user_id, HttpMethod.POST, new StringEntity(s.toJson(), ContentType.APPLICATION_JSON)));
    }

    //</editor-fold>
    //<editor-fold defaultstate="collapsed" desc="READ">
    public TopicGroup getById(String user_id, String id) {
        String uri = base + ControllerConstants.GET_BY_ID2 + id;
        return new TopicGroup().valueOf(Application.clientHandlerInstance().getEntity(uri, user_id, HttpMethod.GET, null));
    }
