...
public class HttpOrganisation {

    private String base = Application.getSettings().getServerUrl() + ControllerConstants.ORGANISATIONPATH;

    //<editor-fold defaultstate="collapsed" desc="CREATE">
    public <S extends Organisation> Organisation create(String user_id, S s) {
        String uri = base + ControllerConstants.CREATE;
        return new Organisation().valueOf(Application.clientHandlerInstance().getEntity(uri, user_id, HttpMethod.POST, new StringEntity(s.toJson(), ContentType.APPLICATION_JSON)));
    }

    //</editor-fold>
    //<editor-fold defaultstate="collapsed" desc="READ">
    public Organisation getById(String user_id, String id) {
        String uri = base + ControllerConstants.GET_BY_ID2 + id;
        return new Organisation().valueOf(Application.clientHandlerInstance().getEntity(uri, user_id, HttpMethod.GET, null));
    }

    //</editor-fold>
    //<editor-fold defaultstate="collapsed" desc="UPDATE">
    public <S extends Organisation> Organisation update(String user_id, S s) {
        String uri = base + ControllerConstants.UPDATE;
        return new Organisation().valueOf(Application.clientHandlerInstance().getEntity(uri, user_id, HttpMethod.PUT, new StringEntity(s.toJson(), ContentType.APPLICATION_JSON)));
    }
